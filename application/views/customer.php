...
<!-- Begin Page Content -->
      ...
      <section class="content">
        ...
        <a class="btn btn-danger" href="<?php echo base_url('index.php/customer/cetak/')?>"><i class="fa fa-print"></i>Print</a>
        ...
        <div class="form-inline mr-auto float-sm-right navbar-form navbar-right">
      	...
      	<table class="table table-striped">
            ...
            <td><?php echo anchor('customer/detail/'.$cst->id,'<div class="btn btn-success btn-sm"><i class="fa fa-search-plus"></i></div>') ?></td>
            <td onclick="javascript: return confirm('Yakin Menghapus?')"><?php echo anchor('customer/hapus/'.$cst->id,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>')?></td>
            <td><?php echo anchor ('customer/edit/'.$cst->id,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
      		</tr>
      	<?php endforeach; ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method ="post" action="<?php echo base_url().'index.php/customer/tambah_aksi' ?>"> 
